app_name = "alcura_diabetes_obesity_disease_mgmt"
app_title = "Alcura Disease Management"
...
# app_include_css = "/assets/alcura_diabetes_obesity_disease_mgmt/css/alcura_diabetes_obesity_disease_mgmt.css"
# app_include_js = "/assets/alcura_diabetes_obesity_disease_mgmt/js/alcura_diabetes_obesity_disease_mgmt.js"

# web_include_css = "/assets/alcura_diabetes_obesity_disease_mgmt/css/alcura_diabetes_obesity_disease_mgmt_web.css"
# web_include_js = "/assets/alcura_diabetes_obesity_disease_mgmt/js/alcura_diabetes_obesity_disease_mgmt_web.js"
...
# before_install = "alcura_diabetes_obesity_disease_mgmt.setup.install.before_install"
after_install = "alcura_diabetes_obesity_disease_mgmt.setup.install.after_install"
before_uninstall = "alcura_diabetes_obesity_disease_mgmt.setup.install.before_uninstall"
# after_uninstall = "alcura_diabetes_obesity_disease_mgmt.setup.install.after_uninstall"

# ---------------------------------------------------------------------------
# App lifecycle hooks (run per-app on bench install / uninstall)
# ---------------------------------------------------------------------------

# before_app_install = "alcura_diabetes_obesity_disease_mgmt.setup.install.before_app_install"
# after_app_install = "alcura_diabetes_obesity_disease_mgmt.setup.install.after_app_install"

# ---------------------------------------------------------------------------
# Desk Notifications
# ---------------------------------------------------------------------------

# notification_config = "alcura_diabetes_obesity_disease_mgmt.notifications.get_notification_config"
...
_cdm_query_conditions = (
	"alcura_diabetes_obesity_disease_mgmt.permissions.cdm_permissions"
...
# 	"Patient Encounter": "alcura_diabetes_obesity_disease_mgmt.overrides.patient_encounter.CDMPatientEncounter",
# }
...
# 	"Patient": "alcura_diabetes_obesity_disease_mgmt.overrides.patient_dashboard.get_dashboard_data",
# }
...
# doc_events = {
# 	"Patient": {
# 		"validate": "alcura_diabetes_obesity_disease_mgmt.overrides.patient_events.validate",
# 	},
# 	"Patient Encounter": {
# 		"on_submit": "alcura_diabetes_obesity_disease_mgmt.overrides.encounter_events.on_submit",
# 	},
# 	"Vital Signs": {
# 		"on_submit": "alcura_diabetes_obesity_disease_mgmt.overrides.vital_signs_events.on_submit",
# 	},
# 	"Lab Test": {
# 		"on_submit": "alcura_diabetes_obesity_disease_mgmt.overrides.lab_test_events.on_submit",
# 	},
# }
...
# 	"cron": {
# 		"0 8 * * *": [
# 			"alcura_diabetes_obesity_disease_mgmt.tasks.send_review_reminders",
# 		],
# 		"*/30 * * * *": [
# 			"alcura_diabetes_obesity_disease_mgmt.tasks.check_monitoring_alerts",
# 		],
# 	},
# 	"daily": [
# 		"alcura_diabetes_obesity_disease_mgmt.tasks.check_overdue_reviews",
# 	],
# 	"weekly": [
# 		"alcura_diabetes_obesity_disease_mgmt.tasks.generate_compliance_summary",
# 	],
# }
...
# 	"healthcare.method.path": "alcura_diabetes_obesity_disease_mgmt.overrides.method_override",
# }
...
# jinja = {
# 	"methods": [
# 		"alcura_diabetes_obesity_disease_mgmt.utils.formatters.format_clinical_value",
# 	],
# }
...
# auth_hooks = [
# 	"alcura_diabetes_obesity_disease_mgmt.auth.validate",
# ]
