frappe.ui.form.on("Patient Encounter", {
	...
	cdm_launch_review(frm) {
		frappe.call({
			method: "alcura_diabetes_obesity_disease_mgmt.api.encounter_context.create_review_from_encounter",
	...
	cdm_load_context_panel(frm) {
		frappe.call({
			method: "alcura_diabetes_obesity_disease_mgmt.api.encounter_context.get_disease_context",
			args: {
				patient: frm.doc.patient,
	...
	cdm_render_panel(frm, ctx) {
		const $wrapper = frm.dashboard.add_section("", __("Alcura Disease Management"));
