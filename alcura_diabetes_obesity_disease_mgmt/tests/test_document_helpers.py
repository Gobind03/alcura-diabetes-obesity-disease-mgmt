...
class TestSafeGetDoc:
	@patch("alcura_diabetes_obesity_disease_mgmt.utils.document_helpers.frappe")
	def test_returns_doc_when_exists(self, mock_frappe):
		mock_frappe.db.exists.return_value = True
		mock_doc = MagicMock()
		mock_frappe.get_doc.return_value = mock_doc

		from alcura_diabetes_obesity_disease_mgmt.utils.document_helpers import safe_get_doc
...
class TestSafeCreateDoc:
	...
	def test_creates_new_doc(self, mock_frappe):
		...
		from alcura_diabetes_obesity_disease_mgmt.utils.document_helpers import safe_create_doc
...
class TestPatientLookup:
	...
	def test_returns_dict_when_exists(self, mock_frappe):
		...
		from alcura_diabetes_obesity_disease_mgmt.utils.document_helpers import patient_lookup
...
class TestProgramLookup:
	...
	def test_returns_none_when_doctype_missing(self, mock_frappe):
		...
		from alcura_diabetes_obesity_disease_mgmt.utils.document_helpers import program_lookup
