...
from alcura_diabetes_obesity_disease_mgmt.constants.statuses import CarePlanStatus
...
class TestCarePlanStatusTransitions:
	...
	def test_draft_to_active(self):
		from alcura_diabetes_obesity_disease_mgmt.utils.validators import validate_care_plan_status_transition
...
class TestCarePlanServiceCreatePlan:
	...
	@patch("alcura_diabetes_obesity_disease_mgmt.services.care_plan.frappe")
...
class TestCDMCarePlanController:
	...
	def test_future_start_date_raises(self):
		from alcura_diabetes_obesity_disease_mgmt.cdm_care_plans.doctype.cdm_care_plan.cdm_care_plan import (
			CDMCarePlan,
		)
