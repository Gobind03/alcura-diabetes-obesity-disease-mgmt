...
class TestReviewServiceCreateFromEncounter:
	...
	@patch("alcura_diabetes_obesity_disease_mgmt.services.review.frappe")
...
class TestReviewSheetAutoLink:
	...
	@patch("alcura_diabetes_obesity_disease_mgmt.cdm_reviews.doctype.disease_review_sheet.disease_review_sheet.frappe")
	def test_auto_links_enrollment(self, mock_frappe):
		from alcura_diabetes_obesity_disease_mgmt.cdm_reviews.doctype.disease_review_sheet.disease_review_sheet import (
			DiseaseReviewSheet,
		)
