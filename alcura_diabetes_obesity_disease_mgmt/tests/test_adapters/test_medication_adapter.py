...
class TestGetCurrentMedications:
	@patch("alcura_diabetes_obesity_disease_mgmt.adapters.medication_adapter.optional_doctype")
	...
	@patch("alcura_diabetes_obesity_disease_mgmt.adapters.medication_adapter.safe_get_all")
	@patch("alcura_diabetes_obesity_disease_mgmt.adapters.medication_adapter.optional_doctype")
...
class TestGetMedicationSnapshot:
	...
	def test_returns_empty_when_no_doctypes(self, mock_optional):
		...
		from alcura_diabetes_obesity_disease_mgmt.adapters.medication_adapter import get_medication_snapshot
		result = get_medication_snapshot("PAT-001")
		assert result == []

	@patch("alcura_diabetes_obesity_disease_mgmt.adapters.medication_adapter.frappe")
	@patch("alcura_diabetes_obesity_disease_mgmt.adapters.medication_adapter.safe_get_all")
	@patch("alcura_diabetes_obesity_disease_mgmt.adapters.medication_adapter.optional_doctype")
...
class TestGetMedicationHistory:
	...
	def test_returns_empty_when_doctype_missing(self, mock_optional):
		...
		from alcura_diabetes_obesity_disease_mgmt.adapters.medication_adapter import get_medication_history
