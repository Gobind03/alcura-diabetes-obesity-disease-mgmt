...
class TestDoctypeExists:
	@patch("alcura_diabetes_obesity_disease_mgmt.adapters.base.frappe")
	def test_returns_true_when_exists(self, mock_frappe):
		mock_frappe.db.exists.return_value = True

		from alcura_diabetes_obesity_disease_mgmt.adapters.base import doctype_exists
...
class TestFieldExists:
	...
	def test_returns_true_when_field_present(self, mock_frappe):
		...
		from alcura_diabetes_obesity_disease_mgmt.adapters.base import doctype_exists, field_exists
		doctype_exists.cache_clear()
...
class TestRequireDoctype:
	...
	def test_passes_when_exists(self, mock_frappe):
		...
		from alcura_diabetes_obesity_disease_mgmt.adapters.base import doctype_exists, require_doctype
		doctype_exists.cache_clear()
...
class TestOptionalDoctype:
	...
	def test_returns_true_when_exists(self, mock_frappe):
		...
		from alcura_diabetes_obesity_disease_mgmt.adapters.base import doctype_exists, optional_doctype
		doctype_exists.cache_clear()
