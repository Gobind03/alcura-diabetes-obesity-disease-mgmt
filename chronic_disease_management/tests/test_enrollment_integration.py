...
class TestCreateEnrollmentWithSource:
	...
	@patch("chronic_disease_management.services.enrollment.frappe")
	@patch("chronic_disease_management.utils.validators.validate_patient_exists")
	@patch("chronic_disease_management.utils.validators.validate_disease_type")
	@patch("chronic_disease_management.services.enrollment.EnrollmentService.check_eligibility")
