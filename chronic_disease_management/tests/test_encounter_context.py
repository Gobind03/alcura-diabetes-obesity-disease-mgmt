...
class TestEncounterContextNoEnrollment:
	...
	@patch("chronic_disease_management.services.encounter_context.doctype_exists")
	@patch("chronic_disease_management.services.encounter_context.frappe")
...
class TestEncounterContextWithEnrollment:
	...
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._get_pending_review")
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._compute_trends")
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._get_care_gaps")
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._get_medications")
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._get_recent_labs")
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._get_recent_vitals")
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._get_active_goals")
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._get_active_care_plan")
	@patch("chronic_disease_management.services.encounter_context.EncounterContextService._get_active_enrollment")
