...
class TestGetLatestEncounter:
	@patch("chronic_disease_management.adapters.encounter_adapter.frappe")
	@patch("chronic_disease_management.adapters.encounter_adapter.require_doctype")
	def test_returns_latest_encounter(self, mock_require, mock_frappe):
		...
		from chronic_disease_management.adapters.encounter_adapter import get_latest_encounter
...
class TestGetEncounterHistory:
	@patch("chronic_disease_management.adapters.encounter_adapter.safe_get_all")
	def test_returns_history_list(self, mock_get_all):
		...
		from chronic_disease_management.adapters.encounter_adapter import get_encounter_history
...
class TestGetEncounterPrescriptions:
	@patch("chronic_disease_management.adapters.encounter_adapter.optional_doctype")
	@patch("chronic_disease_management.adapters.encounter_adapter.require_doctype")
	@patch("chronic_disease_management.adapters.encounter_adapter.frappe")
	def test_returns_all_prescription_types(self, mock_frappe, mock_require, mock_optional):
		...
		from chronic_disease_management.adapters.encounter_adapter import get_encounter_prescriptions
