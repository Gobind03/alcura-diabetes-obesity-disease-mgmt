...
class TestGetLatestVitals:
	@patch("chronic_disease_management.adapters.vitals_adapter.frappe")
	@patch("chronic_disease_management.adapters.vitals_adapter.require_doctype")
...
class TestGetVitalsHistory:
	@patch("chronic_disease_management.adapters.vitals_adapter.safe_get_all")
	def test_returns_history(self, mock_get_all):
		...
		from chronic_disease_management.adapters.vitals_adapter import get_vitals_history
...
class TestGetVitalsTrend:
	...
	def test_returns_trend_data(self, mock_require, mock_frappe):
		...
		from chronic_disease_management.adapters.vitals_adapter import get_vitals_trend
...
class TestGetBmiHistory:
	...
	def test_returns_bmi_records(self, mock_require, mock_frappe):
		...
		from chronic_disease_management.adapters.vitals_adapter import get_bmi_history
