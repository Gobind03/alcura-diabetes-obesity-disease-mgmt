...
def after_install():
	...
	from chronic_disease_management.setup.custom_fields import setup_custom_fields
	from chronic_disease_management.setup.roles import setup_roles

	setup_roles()
	setup_custom_fields()
	_create_default_settings()
	_verify_healthcare_compatibility()
	frappe.logger("chronic_disease_management").info(
		"Chronic Disease Management app installed successfully."
	)


def before_uninstall():
	"""Cleanup before the app is removed from a site."""
	from chronic_disease_management.setup.custom_fields import teardown_custom_fields
	from chronic_disease_management.setup.roles import teardown_roles

	teardown_custom_fields()
	teardown_roles()
	frappe.logger("chronic_disease_management").info(
		"Chronic Disease Management: custom fields and roles removed."
	)
...
def _verify_healthcare_compatibility():
	...
	if missing:
		frappe.logger("chronic_disease_management").warning(
